  ...
  return (
    ...
    >
      ...
      <Section>
        ...
        <div style={{ ...highlightStyle("retention"), fontSize: 13, fontWeight: 700, color: retentionLabel.color, paddingBottom: 2 }}>
          {retentionLabel.text}
        </div>
        {retention.retentionDays !== null && !retention.indefinite && (
          <div style={{ fontSize: 10, color: COLOR.gray }}>{retention.sourceQuote.slice(0, 80)}{retention.sourceQuote.length > 80 ? "…" : ""}</div>
        )}
      </Section>
        ...
        <div style={{ display: "flex", gap: 12 }}>
          ...
          <div style={{ flex: 1, borderLeft: RULE.thin, paddingLeft: 12 }}>
            ...
            {measures.length === 0 ? (
              ...
              measures.map((m, i) => (
                <CheckItem key={i} label={m.name} checked />
              ))
            )}
          </div>
        </div>
      ...
      <Section>
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          <div style={highlightStyle("honorsGPC")}>
            <SignalPill label="GPC" honored={signalHonoring.honorsGPC.value} />
          </div>
          <div style={highlightStyle("honorsDNT")}>
            <SignalPill label="DNT" honored={signalHonoring.honorsDNT.value} />
          </div>
        </div>
      </Section>
